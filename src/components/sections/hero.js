...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Cian Ó Cathasaigh.</h2>;
  const three = (
    <h3 className="big-heading">This is my personal website - feel free to scroll through</h3>
  );
  const four = (
    <>
      <p>
        I hold a BSc in Civil Engineering and an ME in Engineering with Business from University
